...
var level_index = 0;
var level = CONSTANT; // document.querySelector('#btn-level').addEventListener('click', (e) => {
//   console.log(e)
...
document.querySelector('#btn-play').addEventListener('click', function () {
  if (input_name.value.trim().length > 0) {
    alert("'".concat(input_name.value, " you can start the game'"));
  } else {
    console.log('error');
    input_name.classList.add('input-err');
    setTimeout(function () {
      input_name.classList.remove('input-err');
      input_name.focus();
    }, 500);
  }
});
...
var init = function init() {
  ...
  document.querySelector('#btn-continue').style.display ? 'grid' : 'none';
};
