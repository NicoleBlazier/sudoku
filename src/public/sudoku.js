...
const is3x3Safe = (grid, box_row, box_col, value) => {
...
const isSafe = (grid, row, col, value) => {
  return isColSafe(grid, row, value)  && isRowSafe(grid, row, value) && is3x3Safe (grid,
    row - row%3, col - col%3, value) && value !== CONSTANT.UNASSIGNED;
